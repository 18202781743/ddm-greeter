 ...
 * Command line was: qdbusxml2cpp-fix -c AccountsUser -p /home/repo/dde-session-shell/src/global_util/dbus/accountsuser_interface /home/repo/dde-session-shell/xml/org.deepin.dde.Accounts1.User.xml
 *
...
#include "/home/repo/dde-session-shell/src/global_util/dbus/accountsuser_interface.h"

DCORE_USE_NAMESPACE
/*
 * Implementation of interface class __AccountsUser
 */

class __AccountsUserPrivate
{
public:
   __AccountsUserPrivate() = default;
...
__AccountsUser::__AccountsUser(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : DDBusExtendedAbstractInterface(service, path, staticInterfaceName(), connection, parent)
    , d_ptr(new __AccountsUserPrivate)
{
    connect(this, &__AccountsUser::propertyChanged, this, &__AccountsUser::onPropertyChanged);

}

__AccountsUser::~__AccountsUser()
{
    qDeleteAll(d_ptr->m_processingCalls.values());
    delete d_ptr;
}

void __AccountsUser::onPropertyChanged(const QString &propName, const QVariant &value)
{
...
void __AccountsUser::CallQueued(const QString &callName, const QList<QVariant> &args)
{
    ...
    if (d_ptr->m_processingCalls.contains(callName))
    {
        ...
        connect(watcher, &QDBusPendingCallWatcher::finished, this, &__AccountsUser::onPendingCallFinished);
        d_ptr->m_processingCalls.insert(callName, watcher);
    }
}

void __AccountsUser::onPendingCallFinished(QDBusPendingCallWatcher *w)
{
    w->deleteLater();
