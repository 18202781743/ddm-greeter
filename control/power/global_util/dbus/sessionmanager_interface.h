...
#ifndef SESSIONMANAGER_INTERFACE_H
#define SESSIONMANAGER_INTERFACE_H
...
class __SessionManager : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __SessionManager(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
private:
    __SessionManagerPrivate *d_ptr;
};

namespace org {
  namespace deepin {
    namespace dde {
      typedef ::__SessionManager SessionManager1;
    }
  }
}
#endif
