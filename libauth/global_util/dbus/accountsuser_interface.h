...
#ifndef ACCOUNTSUSER_INTERFACE_H
#define ACCOUNTSUSER_INTERFACE_H
...
class __AccountsUser : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __AccountsUser(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
