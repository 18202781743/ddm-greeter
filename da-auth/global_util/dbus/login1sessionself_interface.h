...
#ifndef LOGIN1SESSIONSELF_INTERFACE_H
#define LOGIN1SESSIONSELF_INTERFACE_H
...
class __Login1SessionSelf : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __Login1SessionSelf(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
private:
    __Login1SessionSelfPrivate *d_ptr;
};

namespace org {
  namespace freedesktop {
    namespace login1 {
      typedef ::__Login1SessionSelf Session;
    }
  }
}
#endif
