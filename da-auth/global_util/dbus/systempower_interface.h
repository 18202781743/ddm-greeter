...
#ifndef SYSTEMPOWER_INTERFACE_H
#define SYSTEMPOWER_INTERFACE_H
...
class __SystemPower : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __SystemPower(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
private:
    __SystemPowerPrivate *d_ptr;
};

namespace org {
  namespace deepin {
    namespace dde {
      typedef ::__SystemPower Power1;
    }
  }
}
#endif
