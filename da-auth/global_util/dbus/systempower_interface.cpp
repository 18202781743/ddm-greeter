 ...
 * Command line was: qdbusxml2cpp-fix -c SystemPower -p /home/repo/dde-session-shell/src/global_util/dbus/systempower_interface /home/repo/dde-session-shell/xml/org.deepin.dde.SystemPower1.xml
 *
...
#include "/home/repo/dde-session-shell/src/global_util/dbus/systempower_interface.h"

DCORE_USE_NAMESPACE
/*
 * Implementation of interface class __SystemPower
 */

class __SystemPowerPrivate
{
public:
   __SystemPowerPrivate() = default;
...
__SystemPower::__SystemPower(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : DDBusExtendedAbstractInterface(service, path, staticInterfaceName(), connection, parent)
    , d_ptr(new __SystemPowerPrivate)
{
    connect(this, &__SystemPower::propertyChanged, this, &__SystemPower::onPropertyChanged);

}

__SystemPower::~__SystemPower()
{
    qDeleteAll(d_ptr->m_processingCalls.values());
    delete d_ptr;
}

void __SystemPower::onPropertyChanged(const QString &propName, const QVariant &value)
{
...
void __SystemPower::CallQueued(const QString &callName, const QList<QVariant> &args)
{
    ...
    if (d_ptr->m_processingCalls.contains(callName))
    {
        ...
        connect(watcher, &QDBusPendingCallWatcher::finished, this, &__SystemPower::onPendingCallFinished);
        d_ptr->m_processingCalls.insert(callName, watcher);
    }
}

void __SystemPower::onPendingCallFinished(QDBusPendingCallWatcher *w)
{
    w->deleteLater();
