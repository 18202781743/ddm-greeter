...
class __Accounts : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __Accounts(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
private:
    __AccountsPrivate *d_ptr;
};

namespace org {
  namespace deepin {
    namespace dde {
      typedef ::__Accounts Accounts1;
    }
  }
}
#endif
