...
#ifndef AUTHENTICATESESSION2_INTERFACE_H
#define AUTHENTICATESESSION2_INTERFACE_H
...
class __AuthenticateSession2 : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __AuthenticateSession2(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~__AuthenticateSession2();
...
private:
    __AuthenticateSession2Private *d_ptr;
};
  ...
  namespace deepin {
    namespace dde {
      namespace authenticate1 {
        typedef ::__AuthenticateSession2 Session;
      }
    }
  }
}
